...
{
    /// <summary>
    /// Affect 시스템에서 비주얼 이펙트(Effect)를 재생·중지하기 위한 추상 인터페이스입니다.
    /// </summary>
    /// <remarks>
    ...
    public interface IAffectEffectService
    {
        ...
        /// </summary>
        /// <param name="vfxUid">재생할 Effect를 식별하는 고유 ID입니다.</param>
        /// <param name="target">Effect가 부착되거나 기준이 되는 Affect 대상입니다.</param>
        /// <param name="scale">Effect의 전체 스케일 배율입니다.</param>
        /// <param name="offsetY">대상의 기준 위치에서 Y축으로 이동할 오프셋 값입니다.</param>
        /// <param name="duration">Effect가 유지될 시간(초)이며, 음수 또는 0이면 구현체의 기본 규칙을 따릅니다.</param>
        /// <returns>
        /// 재생 중인 Effect를 식별하기 위한 토큰 객체입니다.
        ...
        /// <summary>
        /// <see cref="Play"/>로 재생된 비주얼 이펙트(Effect)를 중지합니다.
        /// </summary>
        /// <param name="token">
